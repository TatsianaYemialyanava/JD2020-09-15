package by.it.moiseyenko.jd01_14;
...
class TaskA {
    ...
    public static void main(String[] args) {
        String filename = getPath(by.it.moiseyenko.jd01_14.TaskA.class) + FILE_DATA;
        writeRandomInt(filename);
        List<Integer> list = new ArrayList<>();
        readInt(filename, list);
        printToConsole(list);
        String filenameTxt = getPath(by.it.moiseyenko.jd01_14.TaskA.class) + RESULT_TASK_A;
